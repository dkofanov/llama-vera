...
// Generated from grammars/full_sem.grammar by tools/grammar_gen.py. Do not edit.

#include "parser3/core/grammar_element.h"
#include "parser3/core/grammar_stack.h"
#include "parser3/core/semantics.h"

namespace vera::parser3::full_sem {
...
struct Type_End;
struct Type_Char;
struct Field_Declare;
struct Field_Bind;
struct Scope_Begin_Class;
struct Scope_End_Class;
} // namespace nota

} // namespace vera::parser3::full_sem

#include "parser3/examples/full_semantics.h"
...
using Name = ExpandableRule<
    ExpandableRule<Signal<nota::Name_Begin>, IdentifierStart, Signal<nota::Name_Char>,
                   StarArray<ExpandableRule<IdentifierContinue, Signal<nota::Name_Char>>>, Signal<nota::Name_End>>,
    Ws>;
using TypeName = ExpandableRule<
    ExpandableRule<Signal<nota::Type_Begin>, IdentifierStart, Signal<nota::Type_Char>,
                   StarArray<ExpandableRule<IdentifierContinue, Signal<nota::Type_Char>>>, Signal<nota::Type_End>>,
    Ws>;
...
using BasicType = ExpandableRule<FirstMatch<Keyword<'i', 'n', 't'>, Keyword<'n', 'u', 'm', 'b', 'e', 'r'>,
                                 ...
                                 Ws>;
using QualifiedName = ExpandableRule<TypeName, Optional<ExpandableRule<Char::Exact<'.'>, Ws, TypeName>>>;
...
using Field = ExpandableRule<Name, Signal<nota::Field_Declare>, Char::Exact<':'>, Ws, RuleRef<Type>,
                             Signal<nota::Field_Bind>, Char::Exact<';'>, Ws>;
...
using ClassDeclaration =
    ExpandableRule<StarArray<Annotation>, Keyword<'c', 'l', 'a', 's', 's'>, Gap, Name,
                   ExpandableRule<Signal<nota::Scope_Begin_Class>, Char::Exact<'{'>, Ws, StarArray<Field>,
                                  Char::Exact<'}'>, Signal<nota::Scope_End_Class>>,
                   Ws>;
